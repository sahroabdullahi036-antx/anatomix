...
- [Quiz/game distractors](quiz-distractors.md) — dedupe choices by meaning via distinctByKey (42 shared-meaning collisions cause correct picks to score wrong); win-conditions must be data-driven; empty pools render GameEmpty not null
