...
export const ALL_TERMS: MedicalTerm[] = [
  ...
  { id: 's19', term: '-oma', type: 'suffix', meaning: 'tumor, mass', casualMeaning: 'a lump or tumor', system: 'General', example: 'carcinoma (cancerous tumor), melanoma (tumor of melanocytes/pigment cells)', definition: 'Suffix meaning tumor or mass' },
  ...
  { id: 's30', term: '-rrhage, -rrhagia', type: 'suffix', meaning: 'bursting forth (of blood)', casualMeaning: 'bleeding or gushing out suddenly', system: 'General', example: 'hemorrhage (bursting forth of blood), menorrhagia (heavy menstrual flow)', definition: 'Suffix meaning bursting forth of blood; sudden profuse flow from a vessel' },
  ...
  { id: 'r30', term: 'chol/e', type: 'root', meaning: 'bile, gall', casualMeaning: 'bile (digestive fluid from liver)', system: 'Digestive', example: 'cholelithiasis (gallstones), cholangitis (inflammation of bile ducts), cholestasis (stoppage of bile flow)', definition: 'Combining form meaning bile or gall' },
