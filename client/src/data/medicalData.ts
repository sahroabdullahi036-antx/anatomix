...
export const ALL_TERMS: MedicalTerm[] = [
  // PREFIXES
  { id: 'p1', term: 'a-, an-', type: 'prefix', meaning: 'without, not, absence of', casualMeaning: 'none of it / missing completely', system: 'General', example: 'anemia (without enough blood cells), apnea (without breathing)', definition: 'Prefix meaning without or absence of', wordParts: [] },
  ...
  { id: 'p6', term: 'bi-', type: 'prefix', meaning: 'two, double', casualMeaning: 'two of them', system: 'General', example: 'bilateral (both sides)', definition: 'Prefix meaning two' },
  ...
  { id: 'p9', term: 'endo-', type: 'prefix', meaning: 'within, inner', casualMeaning: 'deep inside', system: 'General', example: 'endoscopy (viewing within), endocardium (inner heart lining)', definition: 'Prefix meaning within' },
  { id: 'p10', term: 'epi-', type: 'prefix', meaning: 'upon, above, over', casualMeaning: 'sitting on top of', system: 'General', example: 'epidermis (upon the skin), epiglottis (upon the glottis)', definition: 'Prefix meaning upon or above' },
  { id: 'p11', term: 'eu-', type: 'prefix', meaning: 'good, normal, true', casualMeaning: 'normal and healthy', system: 'General', example: 'eupnea (normal breathing)', definition: 'Prefix meaning good or normal' },
  { id: 'p12', term: 'ex-, exo-', type: 'prefix', meaning: 'out, outside, away from', casualMeaning: 'coming out', system: 'General', example: 'exocrine (secreting outward), exostosis (bone growth outward)', definition: 'Prefix meaning out or outside' },
  ...
  { id: 'p14', term: 'hyper-', type: 'prefix', meaning: 'above, excessive, beyond normal', casualMeaning: 'too much of it', system: 'General', example: 'hypertension (high blood pressure), hyperglycemia (high blood sugar)', definition: 'Prefix meaning excessive or above normal' },
  { id: 'p15', term: 'hypo-', type: 'prefix', meaning: 'below, deficient, under normal', casualMeaning: 'not enough of it', system: 'General', example: 'hypotension (low blood pressure), hypothyroidism (underactive thyroid)', definition: 'Prefix meaning below or deficient' },
  ...
  { id: 'p17', term: 'intra-', type: 'prefix', meaning: 'within, inside', casualMeaning: 'right inside it', system: 'General', example: 'intramuscular (within muscle), intravenous (within a vein)', definition: 'Prefix meaning within' },
  ...
  { id: 'p21', term: 'oligo-', type: 'prefix', meaning: 'few, scanty, little', casualMeaning: 'very few of them', system: 'General', example: 'oliguria (scanty urine output)', definition: 'Prefix meaning few or scanty' },
  { id: 'p22', term: 'para-', type: 'prefix', meaning: 'beside, near, abnormal', casualMeaning: 'next to or gone wrong', system: 'General', example: 'paraplegia (paralysis of lower body), parathyroid (beside the thyroid)', definition: 'Prefix meaning beside or abnormal' },
  { id: 'p23', term: 'peri-', type: 'prefix', meaning: 'around, surrounding', casualMeaning: 'wrapped all around', system: 'General', example: 'pericardium (around the heart), peritoneum (around abdominal organs)', definition: 'Prefix meaning around or surrounding' },
  { id: 'p24', term: 'poly-', type: 'prefix', meaning: 'many, much, excessive', casualMeaning: 'loads and loads of it', system: 'General', example: 'polyuria (excessive urination), polycythemia (many red blood cells)', definition: 'Prefix meaning many or much' },
  ...
  { id: 'p26', term: 'pre-', type: 'prefix', meaning: 'before, in front of', casualMeaning: 'before it happens', system: 'General', example: 'prenatal (before birth)', definition: 'Prefix meaning before' },
  { id: 'p27', term: 'pro-', type: 'prefix', meaning: 'before, forward, in favor of', casualMeaning: 'moving forward or before', system: 'General', example: 'prognosis (before knowing outcome)', definition: 'Prefix meaning before or forward' },
  ...
  { id: 'p31', term: 'syn-, sym-', type: 'prefix', meaning: 'together, with, joined', casualMeaning: 'joined together', system: 'General', example: 'syndrome (symptoms occurring together)', definition: 'Prefix meaning together or joined' },
  ...
  { id: 'p33', term: 'trans-', type: 'prefix', meaning: 'across, through, beyond', casualMeaning: 'passing completely through', system: 'General', example: 'transdermal (through the skin)', definition: 'Prefix meaning across or through' },
  ...
  { id: 's2', term: '-centesis', type: 'suffix', meaning: 'surgical puncture to remove fluid', casualMeaning: 'poking a needle in to drain fluid', system: 'General', example: 'thoracentesis (puncture of chest to drain fluid)', definition: 'Suffix meaning surgical puncture to aspirate fluid' },
  ...
  { id: 's6', term: '-ectasis, -ectasia', type: 'suffix', meaning: 'dilation, expansion, widening', casualMeaning: 'stretched and widened beyond normal', system: 'General', example: 'bronchiectasis (dilation of bronchi)', definition: 'Suffix meaning dilation or expansion of a structure' },
  { id: 's7', term: '-ectomy', type: 'suffix', meaning: 'surgical removal, excision', casualMeaning: 'cutting it completely out', system: 'General', example: 'appendectomy (removal of appendix), gastrectomy (removal of stomach)', definition: 'Suffix meaning surgical removal or excision' },
  { id: 's8', term: '-emia', type: 'suffix', meaning: 'blood condition', casualMeaning: 'a condition in the blood', system: 'Blood', example: 'anemia (deficiency of red blood cells), leukemia (malignant white blood cells)', definition: 'Suffix meaning blood condition' },
  { id: 's9', term: '-genesis', type: 'suffix', meaning: 'origin, production, formation', casualMeaning: 'where it all begins', system: 'General', example: 'carcinogenesis (origin of cancer)', definition: 'Suffix meaning origin or production' },
  ...
  { id: 's12', term: '-ia, -iasis', type: 'suffix', meaning: 'condition, state, process', casualMeaning: 'having that condition', system: 'General', example: 'pneumonia (lung condition), cholelithiasis (gallstone condition)', definition: 'Suffix meaning condition or state' },
  ...
  { id: 's14', term: '-logy', type: 'suffix', meaning: 'study of, science of', casualMeaning: 'the science of studying it', system: 'General', example: 'cardiology (study of the heart), neurology (study of the nervous system)', definition: 'Suffix meaning study of' },
  { id: 's15', term: '-lysis', type: 'suffix', meaning: 'separation, breakdown, destruction', casualMeaning: 'breaking it apart', system: 'General', example: 'hemolysis (destruction of red blood cells)', definition: 'Suffix meaning separation or destruction' },
  ...
  { id: 's18', term: '-oid', type: 'suffix', meaning: 'resembling, like', casualMeaning: 'looks like it but isn\'t', system: 'General', example: 'osteoid (resembling bone)', definition: 'Suffix meaning resembling' },
  { id: 's19', term: '-oma', type: 'suffix', meaning: 'tumor, mass', casualMeaning: 'a lump or tumor', system: 'General', example: 'carcinoma (cancerous tumor), melanoma (skin tumor)', definition: 'Suffix meaning tumor or mass' },
  ...
  { id: 's21', term: '-osis', type: 'suffix', meaning: 'abnormal condition, process', casualMeaning: 'an abnormal process happening', system: 'General', example: 'arteriosclerosis (hardening of arteries), cyanosis (bluish skin)', definition: 'Suffix meaning abnormal condition' },
  { id: 's22', term: '-pathy', type: 'suffix', meaning: 'disease, suffering, feeling', casualMeaning: 'a disease of that organ', system: 'General', example: 'neuropathy (nerve disease), cardiomyopathy (heart muscle disease)', definition: 'Suffix meaning disease or suffering' },
  { id: 's23', term: '-penia', type: 'suffix', meaning: 'deficiency, decrease', casualMeaning: 'dangerously low levels', system: 'Blood', example: 'leukopenia (decrease in white blood cells), thrombocytopenia (low platelets)', definition: 'Suffix meaning deficiency or abnormal decrease' },
  ...
  { id: 's25', term: '-phobia', type: 'suffix', meaning: 'fear, sensitivity', casualMeaning: 'being scared of it', system: 'General', example: 'hydrophobia (fear of water)', definition: 'Suffix meaning fear or sensitivity' },
  { id: 's26', term: '-plasty', type: 'suffix', meaning: 'surgical repair, surgical reconstruction', casualMeaning: 'surgically fixing or reshaping', system: 'General', example: 'rhinoplasty (nose job), arthroplasty (joint repair)', definition: 'Suffix meaning surgical repair or reconstruction' },
  ...
  { id: 's30', term: '-rrhage, -rrhagia', type: 'suffix', meaning: 'excessive flow, hemorrhage', casualMeaning: 'bleeding or gushing out', system: 'General', example: 'hemorrhage (excessive bleeding), menorrhagia (heavy menstrual flow)', definition: 'Suffix meaning bursting forth or excessive flow' },
  { id: 's31', term: '-rrhaphy', type: 'suffix', meaning: 'surgical suturing, stitching', casualMeaning: 'stitching it back together', system: 'General', example: 'herniorrhaphy (stitching a hernia)', definition: 'Suffix meaning surgical suturing' },
  { id: 's32', term: '-rrhea', type: 'suffix', meaning: 'flow, discharge', casualMeaning: 'fluid flowing or draining out', system: 'General', example: 'diarrhea (flow through intestines), rhinorrhea (runny nose)', definition: 'Suffix meaning flow or discharge' },
  ...
  { id: 's36', term: '-stasis', type: 'suffix', meaning: 'stopping, controlling, standing still', casualMeaning: 'halting or controlling', system: 'General', example: 'hemostasis (stopping of blood flow)', definition: 'Suffix meaning stopping or controlling' },
  { id: 's37', term: '-stenosis', type: 'suffix', meaning: 'narrowing, stricture', casualMeaning: 'getting dangerously narrow', system: 'Cardiovascular', example: 'mitral stenosis (narrowing of mitral valve)', definition: 'Suffix meaning narrowing of a passage' },
  { id: 's38', term: '-stomy', type: 'suffix', meaning: 'surgical opening, artificial mouth', casualMeaning: 'cutting a permanent opening', system: 'General', example: 'colostomy (surgical opening in colon), tracheostomy (opening in trachea)', definition: 'Suffix meaning surgical creation of an opening' },
  ...
  { id: 's40', term: '-tomy', type: 'suffix', meaning: 'surgical incision, cutting into', casualMeaning: 'cutting into it with a blade', system: 'General', example: 'laparotomy (incision into abdomen), phlebotomy (incision into vein)', definition: 'Suffix meaning surgical incision' },
  { id: 's41', term: '-trophy', type: 'suffix', meaning: 'nourishment, development, growth', casualMeaning: 'how it grows and nourishes', system: 'General', example: 'hypertrophy (overgrowth), atrophy (wasting away)', definition: 'Suffix meaning nourishment or development' },
  ...
  { id: 'r4', term: 'angi/o', type: 'root', meaning: 'vessel (usually blood vessel)', casualMeaning: 'a blood vessel', system: 'Cardiovascular', example: 'angiography, angioplasty', definition: 'Combining form meaning vessel' },
  ...
  { id: 'r6', term: 'atri/o', type: 'root', meaning: 'atrium (upper heart chamber)', casualMeaning: 'the top receiving rooms of the heart', system: 'Cardiovascular', example: 'atrial fibrillation, atrioventricular', definition: 'Combining form meaning atrium' },
  ...
  { id: 'r12', term: 'pneum/o, pneumon/o', type: 'root', meaning: 'lung, air, breath', casualMeaning: 'air or the lungs', system: 'Respiratory', example: 'pneumonia, pneumothorax, pneumonectomy', definition: 'Combining form meaning lung or air' },
  { id: 'r13', term: 'bronch/o', type: 'root', meaning: 'bronchus (airway branch)', casualMeaning: 'the big breathing branches', system: 'Respiratory', example: 'bronchitis, bronchoscopy, bronchodilator', definition: 'Combining form meaning bronchus' },
  { id: 'r14', term: 'alveol/o', type: 'root', meaning: 'alveolus (air sac)', casualMeaning: 'the tiny air sacs in the lungs', system: 'Respiratory', example: 'alveolar, alveolitis', definition: 'Combining form meaning alveolus' },
  { id: 'r15', term: 'laryng/o', type: 'root', meaning: 'larynx (voice box)', casualMeaning: 'the voice box', system: 'Respiratory', example: 'laryngitis, laryngoscopy, laryngectomy', definition: 'Combining form meaning larynx' },
  { id: 'r16', term: 'pharyng/o', type: 'root', meaning: 'pharynx (throat)', casualMeaning: 'the back of the throat', system: 'Respiratory', example: 'pharyngitis, nasopharynx', definition: 'Combining form meaning pharynx' },
  { id: 'r17', term: 'trache/o', type: 'root', meaning: 'trachea (windpipe)', casualMeaning: 'the windpipe', system: 'Respiratory', example: 'tracheotomy, tracheostomy, tracheal', definition: 'Combining form meaning trachea' },
  { id: 'r18', term: 'pleur/o', type: 'root', meaning: 'pleura (lung membrane)', casualMeaning: 'the lung\'s outer wrapper', system: 'Respiratory', example: 'pleuritis, pleurisy, pleurotomy', definition: 'Combining form meaning pleura' },
  { id: 'r19', term: 'thorac/o', type: 'root', meaning: 'chest, thorax', casualMeaning: 'the chest cavity', system: 'Respiratory', example: 'thoracotomy, thoracentesis, thoracic', definition: 'Combining form meaning chest or thorax' },
  ...
  { id: 'r24', term: 'esophag/o', type: 'root', meaning: 'esophagus (food tube)', casualMeaning: 'the food pipe', system: 'Digestive', example: 'esophagitis, esophagoscopy', definition: 'Combining form meaning esophagus' },
  ...
  { id: 'r26', term: 'col/o, colon/o', type: 'root', meaning: 'colon (large intestine)', casualMeaning: 'the large intestine', system: 'Digestive', example: 'colitis, colonoscopy, colectomy', definition: 'Combining forms meaning colon' },
  ...
  { id: 'r30', term: 'chol/e', type: 'root', meaning: 'bile, gall', casualMeaning: 'bile (digestive fluid from liver)', system: 'Digestive', example: 'cholelithiasis (gallstones), cholesterol', definition: 'Combining form meaning bile' },
  { id: 'r31', term: 'rect/o', type: 'root', meaning: 'rectum', casualMeaning: 'the rectum', system: 'Digestive', example: 'rectal, rectocele, proctoscopy', definition: 'Combining form meaning rectum' },
  ...
  { id: 'r36', term: 'cerebr/o', type: 'root', meaning: 'cerebrum (thinking brain)', casualMeaning: 'the thinking brain', system: 'Nervous', example: 'cerebral, cerebrospinal fluid, cerebrovascular', definition: 'Combining form meaning cerebrum' },
  { id: 'r37', term: 'myel/o', type: 'root', meaning: 'spinal cord (also bone marrow)', casualMeaning: 'the spinal cord OR bone marrow', system: 'Nervous', example: 'myelitis (spinal cord inflammation), myelogram', definition: 'Combining form meaning spinal cord or bone marrow', homonymWarning: 'myel/o means spinal cord in neurology (myelitis, myelogram) but means bone marrow in hematology (myelocyte, myelogenous leukemia). Always check the system context!', alternativeSystems: ['Blood'] },
  { id: 'r38', term: 'mening/o', type: 'root', meaning: 'meninges (brain membranes)', casualMeaning: 'the membranes wrapping the brain', system: 'Nervous', example: 'meningitis, meningioma', definition: 'Combining form meaning meninges' },
  { id: 'r39', term: 'cerebell/o', type: 'root', meaning: 'cerebellum (balance brain)', casualMeaning: 'the balance part of the brain', system: 'Nervous', example: 'cerebellar, cerebellitis', definition: 'Combining form meaning cerebellum' },
  ...
  { id: 'r45', term: 'crani/o', type: 'root', meaning: 'skull, cranium', casualMeaning: 'the skull', system: 'Musculoskeletal', example: 'craniotomy, cranial, intracranial', definition: 'Combining form meaning skull' },
  ...
  { id: 'r53', term: 'ur/o', type: 'root', meaning: 'urine, urinary tract', casualMeaning: 'urine or the urinary system', system: 'Urinary', example: 'urology, urinalysis', definition: 'Combining form meaning urine' },
  ...
  { id: 'r62', term: 'lymph/o', type: 'root', meaning: 'lymph, lymphatic system', casualMeaning: 'the lymph fluid / immune drainage', system: 'Lymphatic', example: 'lymphoma, lymphocyte, lymphedema', definition: 'Combining form meaning lymph' },
  { id: 'r63', term: 'lymphaden/o', type: 'root', meaning: 'lymph node (gland)', casualMeaning: 'a lymph node or gland', system: 'Lymphatic', example: 'lymphadenopathy, lymphadenectomy', definition: 'Combining form meaning lymph node' },
  ...
  { id: 'r66', term: 'hyster/o, uter/o, metr/o', type: 'root', meaning: 'uterus (womb)', casualMeaning: 'the uterus or womb', system: 'Reproductive', example: 'hysterectomy (removal of uterus), uterine, endometrium', definition: 'Combining forms meaning uterus' },
  ...
  { id: 'r69', term: 'orch/o, orchid/o', type: 'root', meaning: 'testis (testicle)', casualMeaning: 'the testicle', system: 'Reproductive', example: 'orchitis, orchidectomy', definition: 'Combining forms meaning testis' },
  ...
  { id: 'r74', term: 'thrombocyt/o', type: 'root', meaning: 'platelet (clotting cell)', casualMeaning: 'platelets that help blood clot', system: 'Blood', example: 'thrombocytopenia, thrombocytosis', definition: 'Combining form meaning platelet' },
  ...
  { id: 'c4', term: 'Hypertension', type: 'condition', meaning: 'Chronically elevated blood pressure (≥130/80 mmHg)', casualMeaning: 'high blood pressure', system: 'Cardiovascular', example: 'Essential hypertension, hypertensive crisis', definition: 'Persistently elevated arterial blood pressure; classified as essential (primary, no known cause) or secondary (due to another disease)' },
